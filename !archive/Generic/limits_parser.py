...
class Limits(object):
    def __init__(self, filepath, sheet):
        ...
        self.sheet = sheet
        self.product, self.rev, self.row23, self.rowm40, self.row85, self.row45, self.row60, self.mode_cols, self.modes, self.boards_dict, self.outage_link, self.mm_lims = get_info(self.filepath, self.sheet)
